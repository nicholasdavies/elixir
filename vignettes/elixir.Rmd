...
Finally, `meld()`, `translate()`, and `reindent()` are functions for 
constructing code using R. They are currently not exported from the `elixir`
namespace, but they are documented.
